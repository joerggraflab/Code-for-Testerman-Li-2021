...
```
    ...
    ## 2021-10-14 12:59:13 - Starting PERMANOVA with 999 perms with 1 processes

    ## 2021-10-14 12:59:13 - Finished PERMANOVA
...
```
    ...
    ## 2021-10-14 13:01:32 - Starting PERMANOVA with 999 perms with 1 processes

    ## 2021-10-14 13:01:32 - Finished PERMANOVA
...
```
    ...
    ## $group
    ##                          diff         lwr          upr     p adj
    ## Positive-Negative -0.04985214 -0.09745907 -0.002245203 0.0406606
...
```
    ...
    ## 2021-10-14 13:01:33 - Starting PERMANOVA with 999 perms with 1 processes

    ## 2021-10-14 13:01:33 - Finished PERMANOVA
...
```
    ...
    ## $group
    ##                          diff        lwr        upr     p adj
    ## Positive-Negative -0.04277275 -0.1001158 0.01457031 0.1387949
...
```
    ...
    ## 2021-10-14 13:01:34 - Starting PERMANOVA with 999 perms with 1 processes

    ## 2021-10-14 13:01:34 - Finished PERMANOVA
...
```
    ...
    ## $group
    ##                           diff         lwr        upr     p adj
    ## Positive-Negative -0.008828683 -0.08187281 0.06421544 0.8074431
...
```
    ...
    ## $group
    ##                           diff         lwr        upr     p adj
    ## Positive-Negative -0.007955377 -0.08036081 0.06445006 0.8246474
...
```
    ...
    ## 2021-10-14 13:01:35 - Starting PERMANOVA with 999 perms with 1 processes

    ## 2021-10-14 13:01:35 - Finished PERMANOVA
...
```
    ...
    ## $group
    ##                          diff        lwr        upr     p adj
    ## Positive-Negative -0.05317927 -0.1240268 0.01766828 0.1364002
...
ggsave("Supplemental_Figure_1.tiff", width = 18, height = 5)
```
...
```
    ...
    ##  1 Firmic~ Negat~ 0.561              34.6    NA     NA          1.33  1.56  2.44
    ##  2 Bacter~ Negat~ 0.332              34.6    NA     NA          1.33  1.56  2.44
    ##  3 Actino~ Negat~ 0.0795             34.6    NA     NA          1.33  1.56  2.44
    ##  4 Verruc~ Negat~ 0.0188             34.6    NA     NA          1.33  1.56  2.44
    ##  5 Euryar~ Negat~ 0.00350            34.6    NA     NA          1.33  1.56  2.44
    ##  6 Proteo~ Negat~ 0.00461            34.6    NA     NA          1.33  1.56  2.44
    ##  7 Viruse~ Negat~ 0.000920           34.6    NA     NA          1.33  1.56  2.44
    ##  8 other   Negat~ 0.000119           34.6    NA     NA          1.33  1.56  2.44
    ##  9 Firmic~ Posit~ 0.721              50.4    NA     NA          1.67  1.39  2.44
    ## 10 Bacter~ Posit~ 0.0667             50.4    NA     NA          1.67  1.39  2.44
    ## 11 Actino~ Posit~ 0.188              50.4    NA     NA          1.67  1.39  2.44
    ## 12 Verruc~ Posit~ 0.00919            50.4    NA     NA          1.67  1.39  2.44
    ## 13 Euryar~ Posit~ 0.00916            50.4    NA     NA          1.67  1.39  2.44
    ## 14 Proteo~ Posit~ 0.00315            50.4    NA     NA          1.67  1.39  2.44
    ## 15 Viruse~ Posit~ 0.00217            50.4    NA     NA          1.67  1.39  2.44
    ## 16 other   Posit~ 0.0000375          50.4    NA     NA          1.67  1.39  2.44
...
```
    ...
    ##    OTU     Sample Abundance Sample_Number NAFLD PNPLA3 Visceral.Subc   sex race2
    ##    <chr>   <chr>      <dbl>         <dbl> <dbl>  <dbl>         <dbl> <dbl> <dbl>
    ##  1 Faecal~ Negat~    0.127           34.6    NA     NA          1.33  1.56  2.44
    ##  2 Eubact~ Negat~    0.0457          34.6    NA     NA          1.33  1.56  2.44
    ##  3 Prevot~ Negat~    0.100           34.6    NA     NA          1.33  1.56  2.44
    ##  4 Bifido~ Negat~    0.0231          34.6    NA     NA          1.33  1.56  2.44
    ##  5 Bacter~ Negat~    0.0748          34.6    NA     NA          1.33  1.56  2.44
    ##  6 Fusica~ Negat~    0.0157          34.6    NA     NA          1.33  1.56  2.44
    ##  7 Rumino~ Negat~    0.0325          34.6    NA     NA          1.33  1.56  2.44
    ##  8 Anaero~ Negat~    0.0296          34.6    NA     NA          1.33  1.56  2.44
    ##  9 Eubact~ Negat~    0.0271          34.6    NA     NA          1.33  1.56  2.44
    ## 10 Dorea ~ Negat~    0.0170          34.6    NA     NA          1.33  1.56  2.44
...
ggsave("Supplemental_Figure_Mean_Barplot.tiff", width = 10, height = 3)
```
...
shotgun_species_comp <- ggplot(melted_phy_subset_species, aes(x=NAFLD, y=Abundance)) + 
  geom_boxplot(outlier.shape = NA) + geom_dotplot(binaxis='y', stackdir='center', dotsize = 0) + theme_bw() + facet_wrap(~Species, scales = "free", nrow = 1) + geom_point(aes(colour = NAFLD)) + scale_color_manual(labels = c("NAFLD-negative", "NAFLD-positive"), values = c("#56B4E9", "#D55E00")) + labs(color = "NAFLD Status") + theme(text = element_text(size = 16)) + theme(axis.text.x=element_blank(), axis.title.x = element_blank()) + ylab("Relative Abundance") + scale_y_continuous(labels = comma)
...
shotgun_genus_comp <- ggplot(melted_phy_subset_genus, aes(x=NAFLD, y=Abundance)) + 
  geom_boxplot(outlier.shape = NA) + geom_dotplot(binaxis='y', stackdir='center', dotsize = 0) + theme_bw() + facet_wrap(~Genus, scales = "free", nrow = 1) + geom_point(aes(colour = NAFLD)) + scale_color_manual(labels = c("NAFLD-negative", "NAFLD-positive"), values = c("#56B4E9", "#D55E00")) + labs(color = "NAFLD Status") + theme(text = element_text(size = 16)) + theme(axis.text.x=element_blank(), axis.title.x = element_blank()) + ylab("Relative Abundance")
shotgun_genus_comp
```
...
shotgun_family_comp <- ggplot(melted_phy_subset_family, aes(x=NAFLD, y=Abundance)) + 
  geom_boxplot(outlier.shape = NA) + geom_dotplot(binaxis='y', stackdir='center', dotsize = 0) + theme_bw() + facet_wrap(~Family, scales = "free", nrow = 1) + geom_point(aes(colour = NAFLD)) + scale_color_manual(labels = c("NAFLD-negative", "NAFLD-positive"), values = c("#56B4E9", "#D55E00")) + labs(color = "NAFLD Status") + theme(text = element_text(size = 16)) + theme(axis.text.x=element_blank(), axis.title.x = element_blank()) + ylab("Relative Abundance")
shotgun_family_comp
```
...
shotgun_order_comp <- ggplot(melted_phy_subset_order, aes(x=NAFLD, y=Abundance)) + 
  geom_boxplot(outlier.shape = NA) + geom_dotplot(binaxis='y', stackdir='center', dotsize = 0) + theme_bw() + facet_wrap(~Order, scales = "free", nrow = 1) + geom_point(aes(colour = NAFLD)) + scale_color_manual(labels = c("NAFLD-negative", "NAFLD-positive"), values = c("#56B4E9", "#D55E00")) + labs(color = "NAFLD Status") + theme(text = element_text(size = 16)) + theme(axis.text.x=element_blank(), axis.title.x = element_blank()) + ylab("Relative Abundance")
shotgun_order_comp
```
...
shotgun_class_comp <- ggplot(melted_phy_subset_class, aes(x=NAFLD, y=Abundance)) + 
  geom_boxplot(outlier.shape = NA) + geom_dotplot(binaxis='y', stackdir='center', dotsize = 0) + theme_bw() + facet_wrap(~Class, scales = "free", nrow = 1) + geom_point(aes(colour = NAFLD)) + scale_color_manual(labels = c("NAFLD-negative", "NAFLD-positive"), values = c("#56B4E9", "#D55E00")) + labs(color = "NAFLD Status") + theme(text = element_text(size = 16)) + theme(axis.text.x=element_blank(), axis.title.x = element_blank()) + ylab("Relative Abundance")
shotgun_class_comp
```
...
shotgun_phylum_comp <- ggplot(melted_phy_subset_phylum, aes(x=NAFLD, y=Abundance)) + 
  geom_boxplot(outlier.shape = NA) + geom_dotplot(binaxis='y', stackdir='center', dotsize = 0) + theme_bw() + facet_wrap(~Phylum, scales = "free", nrow = 1) + geom_point(aes(colour = NAFLD)) + scale_color_manual(labels = c("NAFLD-negative", "NAFLD-positive"), values = c("#56B4E9", "#D55E00")) + labs(color = "NAFLD Status") + theme(text = element_text(size = 16)) + theme(axis.text.x=element_blank(), axis.title.x = element_blank()) + ylab("Relative Abundance")
shotgun_phylum_comp
```
...
``` r
ggsave("Supplemental_Figure_Species_Barplot.tiff", width = 16, height = 6)
```
...
``` r
ggsave("Supplemental_Figure_Genus_Barplot.tiff", width = 12, height = 6)
```
...
``` r
ggsave("Supplemental_Figure_Family_Barplot.tiff", width = 12, height = 6)
```
...
``` r
ggsave("Supplemental_Figure_Order_Barplot.tiff", width = 12, height = 6)
```
...
``` r
ggsave("Supplemental_Figure_Class_Barplot.tiff", width = 12, height = 6)
```
...
``` r
ggsave("Supplemental_Figure_Phylum_Barplot.tiff", width = 12, height = 6)
```
