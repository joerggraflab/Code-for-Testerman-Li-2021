...
```
    ...
    ## 2021-10-14 12:46:23 - Starting PERMANOVA with 999 perms with 1 processes

    ## 2021-10-14 12:46:23 - Finished PERMANOVA
...
```
    ...
    ## 2021-10-14 12:48:53 - Starting PERMANOVA with 999 perms with 1 processes

    ## 2021-10-14 12:48:53 - Finished PERMANOVA
...
```
    ...
    ## 2021-10-14 12:48:55 - Starting PERMANOVA with 999 perms with 1 processes

    ## 2021-10-14 12:48:55 - Finished PERMANOVA
...
```
    ...
    ## 2021-10-14 12:48:56 - Starting PERMANOVA with 999 perms with 1 processes

    ## 2021-10-14 12:48:56 - Finished PERMANOVA
...
```
    ...
    ## 2021-10-14 12:48:57 - Starting PERMANOVA with 999 perms with 1 processes

    ## 2021-10-14 12:48:57 - Finished PERMANOVA
